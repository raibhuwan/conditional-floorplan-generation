...
OUT_CSV = "outputs/metrics_cgan_morphology.csv"
os.makedirs("outputs", exist_ok=True)


def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate cGAN with morphology refinement on the held-out test set.")
...
def main():
    ...
    print(f"Evaluating cGAN + morphology on held-out test samples: {len(test_ds)}")
