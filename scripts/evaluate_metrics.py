...
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate U-Net baseline on the held-out test set.")
...
def main():
    ...
    print(f"Evaluating U-Net on held-out test samples: {len(test_ds)}")
