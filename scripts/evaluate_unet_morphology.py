...
OUT_CSV = "outputs/metrics_unet_morphology.csv"
os.makedirs("outputs", exist_ok=True)


def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate U-Net with morphology refinement on the held-out test set.")
...
def main():
    ...
    print(f"Evaluating U-Net + morphology on held-out test samples: {len(test_ds)}")
    ...
    for idx, (x, y) in enumerate(loader):
        ...
        # Apply morphology refinement to U-Net prediction
